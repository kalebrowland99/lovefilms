...
export function YoutubePreview({
  ...
  useEffect(() => {
    ...
    setEmbedSrc(
      `https://www.youtube-nocookie.com/embed/${videoId}?enablejsapi=1&controls=0&disablekb=1&fs=0&rel=0&modestbranding=1&iv_load_policy=3&playsinline=1&autoplay=0${startParam}&origin=${origin}`
    );
  ...
  const togglePlayback = () => {
    ...
    if (!hasStartedRef.current && startSeconds > 0) {
