    ...
    <footer className={cn("bg-white dark:bg-neutral-950 text-black dark:text-white pt-32 pb-12", className)}>
      <div className="max-w-container mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left w-full">
          ...
          />
          <p className="text-neutral-600 dark:text-neutral-400 text-sm mb-4">Capturing love stories nationwide</p>
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-neutral-600 dark:text-neutral-400 text-sm mt-4">Proudly serving couples nationwide.</p>
        </div>
      </div>
