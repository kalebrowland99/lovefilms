...
export const PORTFOLIO_BLOCKS: CanvasBlock[] = [
  { slug: "hero", dh: 1345, mh: 731, bg: "rgba(7,7,7,1)", els: [
    ...
    { sid: "hero_7", kind: "text", d: {l:139, t:953, w:923, h:179}, m: {l:26, t:417, w:289, h:213, hide:true}, text: "ROMANTIC WEDDING FILMS {{i}}and{{/i}} PHOTOGRAPHY NATIONWIDE {{i}}and{{/i}} BEYOND", ds: {"ff": "display", "fs": 62.0, "lh": 0.95, "ls": "0.01em", "ta": "center", "tt": "none", "c": "rgba(255,255,255,1)", "fst": "normal", "fw": 400}, ms: {"ff": "display", "fs": 32.0, "lh": 1.1, "ls": "0.01em", "ta": "center", "tt": "none", "c": "rgba(255,255,255,1)", "fst": "normal", "fw": 400} },
